...
PILOT_REQUESTS_COLLECTION="${CITYLENS_PILOT_REQUESTS_COLLECTION:-pilot_requests}"
...
gcloud run deploy "${API_SERVICE_NAME}" \
  ...
  --update-env-vars "GOOGLE_CLOUD_PROJECT=${PROJECT_ID},CITYLENS_REGION=${REGION},CITYLENS_BUCKET=${BUCKET_NAME},CITYLENS_JOB_NAME=${JOB_NAME},CITYLENS_RUNS_COLLECTION=${RUNS_COLLECTION},CITYLENS_USERS_COLLECTION=${USERS_COLLECTION},CITYLENS_PILOT_REQUESTS_COLLECTION=${PILOT_REQUESTS_COLLECTION},CITYLENS_SIGN_URLS=${SIGN_URLS},CITYLENS_SIGN_URL_TTL_SECONDS=${SIGN_URL_TTL_SECONDS},CITYLENS_ALLOW_ADMIN_API_KEYS=${CITYLENS_ALLOW_ADMIN_API_KEYS:-false},CITYLENS_ADMIN_API_KEY_HASHES=${CITYLENS_ADMIN_API_KEY_HASHES:-},CITYLENS_ALLOW_USER_API_KEYS=${CITYLENS_ALLOW_USER_API_KEYS:-true}"
